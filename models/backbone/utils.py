...
def forward_default(pretrained, x, prompt,  function_name="forward_features"):
    exec(f"pretrained.model.{function_name}(x , prompt)")
...
def forward_adapted_unflatten(pretrained, x, prompt, function_name="forward_features"):
    b, c, h, w = x.shape

    exec(f"glob = pretrained.model.{function_name}(x, prompt)")
