...
class WindowAttention(nn.Module):
    ...
    def __init__(
            self,num_prompts , prompt_location , dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0.,
...
class PatchMerging(nn.Module):
    ...
    def __init__(self, num_prompts , prompt_location , input_resolution, dim, norm_layer=nn.LayerNorm):
        super().__init__()
    ...
    def __init__(
        ...
        if downsample is not None:
            if num_prompts is None:
                ...
                self.downsample = downsample(num_prompts , prompt_location , 
